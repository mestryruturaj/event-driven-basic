...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderEvent> loadConcurrentKafkaListenerContainerFactory(@Qualifier("loadConsumerFactory") ConsumerFactory<String, OrderEvent> consumerFactory) {
