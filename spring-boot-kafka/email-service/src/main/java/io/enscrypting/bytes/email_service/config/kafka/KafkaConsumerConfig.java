package io.enscrypting.bytes.email_service.config.kafka;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderEvent> loadConcurrentKafkaListenerContainerFactory(ConsumerFactory<String, OrderEvent> consumerFactory) {
